...
function onConnected(){
	...
	var blueTeamScore = new PIXI.Text("0", {font:"50px Exo", fill:COLOURS.BLUE});
	var redTeamScore = new PIXI.Text("0", {font:"50px Exo", fill:COLOURS.RED});
	blueTeamScore.position.x = 50;
	redTeamScore.position.x = SCREEN.WIDTH - 50;

	var roundTime = new PIXI.Text("-- : --", {font:"50px Exo", fill:COLOURS.WHITE});
	...
	socket.on("roundComplete", function(data){
		var winText = new PIXI.Text("", {font:"50px Exo", fill:"black"});
